...
f1.pack(side=LEFT)
f2 = Frame(root, width=300, height=700, bd=8, bg="Gray", relief=RIDGE)
f2.pack(side=RIGHT)

fla = Frame(f1, width=600, height=200, bd=8, bg="Gray", relief=RIDGE)
fla.pack(side=TOP)
...
def enterinfo():
    txtpayslip.delete("1.0", END)
    txtpayslip.insert(END, "\t\tGeneral\n\n")
    txtpayslip.insert(END, "EmployeeID :\t\t" + EmployeeID.get() + "\n\n")
    txtpayslip.insert(END, "Gender :\t\t" + Gender.get() + "\n\n")
    txtpayslip.insert(END, "Employee Name :\t\t" + Employer.get() + "\n\n")
    txtpayslip.insert(END, "Position :\t\t" + Position.get() + "\n\n")
    txtpayslip.insert(END, "Basic Salary :\t\t" + BasicSalary.get() + "\n\n")
    txtpayslip.insert(END, "FinalPay :\t\t" + FinalPayable.get() + "\n\n")
...
etxEployeeID = Entry(fla, textvariable=EmployeeID, font=('arial', 16, 'bold'), bd=16, width=22, justify='left')
